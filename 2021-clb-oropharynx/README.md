...
This is detailed in their publication [[1]](#1) and we are planning to submit a manuscript describing to the data the *Data in Brief* journal.
...
1. **`patient:`** General information about the patient's condition can be found under this top-level header.
    1. **`core:`** The second level under patient has no meaning and exists solely as a filler.
        ...
        8. **`pack_years:`** Number of pack years of smoking history of the patient.
...
4. **`pathology:`** Columns under this header contain pathologically assessed involvement information for each LNL.
    1. **`core:`** The second level header contains general information on the pathology.
