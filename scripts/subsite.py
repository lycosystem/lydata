...
SUBSITE_DICT = {
    "oropharynx": {
        ...
        "other": ["C10", "C10.0", "C10.1", "C10.2", "C10.3", "C10.4", "C10.8", "C10.9"],
    },
    "hypopharynx": {
        "all": ["C12", "C12.9", "C13", "C13.0", "C13.1", "C13.2", "C13.8", "C13.9"],
    },
    "larynx": {
    ...
    "oral cavity": {
        "lips": ["C00", "C00.1", "C00.2", "C00.3", "C00.4", "C00.5", "C00.8", "C00.9"],
        "tongue": [
            "C02",
            "C02.0",
            "C02.1",
...
def main() -> None:
    ...
    labels = []
    max_count = 0
    for location, subdict in sorted_subsites.items():
        location_positions = []
        location_values = []
        for subsite, count in subdict.items():
            if count > max_count:
                max_count = count
            icds = set(SUBSITE_DICT[location][subsite])
